...
<body>
        ...
        <div class="row">
          <div class="col-md-5 col-md-push-7">
            <div class="banner_content">
              ...
              <p>Experience the Industry best car renting service.</p>
              <a href="#carz" class="btn">Browse Cars<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Resent Cat-->
  <section class="section-padding gray-bg" id="carz">
    <div class="container">
      <div class="section-header text-center">
        <h2>Find the Best <span>CarForYou</span></h2>
        <p>Select the best option suitable to you from our wide range of cars varying from extra mileage CNG hatchbacks to Offroading SUVs and premium luxury cars.</p>
      </div>
      <div class="row">
